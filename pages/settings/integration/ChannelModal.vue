      ...
      <UiForm v-if="true" v-slot="{ values }" :validation-schema="formSchema" @submit="handleConnect"
        ...
        <UiFormField v-slot="{ componentField }" name="name">
          <UiFormItem class="w-full">
            ...
            <UiFormControl>
              <UiInput type="text" v-bind="componentField" placeholder="Enter Your Channel Name" />
            </UiFormControl>
            <UiFormMessage />
          </UiFormItem>
        </UiFormField>
        ...
        <UiFormField v-slot="{ componentField }" name="pid">
          <UiFormItem class="w-full">
            <UiFormLabel>pid <UiLabel class="text-lg text-red-500">*</UiLabel>
            </UiFormLabel>
            <UiFormControl>
              <UiInput type="text" v-bind="componentField" placeholder="Enter" />
            </UiFormControl>
            <UiFormMessage />
          </UiFormItem>
        </UiFormField>
        <UiFormField v-slot="{ componentField }" name="token">
          <UiFormItem class="w-full">
            <UiFormLabel>Token <UiLabel class="text-lg text-red-500">*</UiLabel>
            </UiFormLabel>
            <UiFormControl>
              <UiInput type="text" v-bind="componentField" placeholder="Enter Token" />
            </UiFormControl>
            <UiFormMessage />
          </UiFormItem>
        </UiFormField>
