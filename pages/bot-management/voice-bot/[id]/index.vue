            ...
            <div class="flex items-center gap-3">
              ...
              <span v-if="botDetails.documentId" class="flex items-center gap-4">
                <div class="flex flex-col items-center gap-1">
                  <UiButton
                    class="rounded-[8px] bg-[#ff0000] p-2.5 text-[14px] font-medium text-white hover:bg-[#ff0000] hover:brightness-90 p-2"
                    @click="deactivateBot">
                    <!-- Deactivate Bot -->
                  ...
                  <div class="block lg:hidden text-[7px]">Deactivate Bot</div>
                </div>
                ...
                <div class="flex flex-col items-center gap-1">
                  <UiButton as="a" :href="previewUrl" target="_blank"
                    class="bg-[#474df9] text-[14px] font-medium text-white hover:bg-[#474df9] hover:brightness-90 p-2">
                  ...
                  <div class="block lg:hidden text-[7px]">Preview Bot</div>
                </div>
                <div class="flex flex-col items-center gap-1">
                  <UiButton class="bg-[#e1dede] text-black hover:bg-[#d4d2d2] p-2" @click="copyScript">
                    <span class="hidden lg:inline"> Copy Script </span>
                    <span class="flex items-center justify-center lg:hidden">
                      <Icon name="mdi:content-copy" class="h-4 w-4 text-white px-1" />
                    </span>
                  </UiButton>
                  <div class="block lg:hidden text-[7px]">Copy Script</div>
                </div>
              </span>
              <div class="flex flex-col items-center gap-1">
                <UiButton variant="destructive" @click="handleDelete"
                  class="bg-[#ff0000] pl-4 hover:bg-[#ff0000]/90 hover:brightness-90 p-2">
...
const dataList = ref([
  {
    ...
    helperText: "This bot assists with managing user identities, including authentication, authorization, and user profiles.",
    routeName: "bot-management-voice-bot-id-identity-management",
  },
  {
    _id: 2,
    bot: "CRM Configuration",
    helperText: "Configure CRM integration for the voice bot, enabling it to access and update customer data during voice interactions.",
    routeName: "bot-management-voice-bot-id-crm-config",
  },
  {
    _id: 3,
    bot: "LLM Configuration",
    helperText: "Set up large language models for the voice bot, optimizing it for understanding and generating natural language responses.",
    routeName: "bot-management-voice-bot-id-llm-config",
  },
  {
    _id: 4,
    bot: "IVR Configuration",
    helperText: "Configure the IVR settings to manage call flows and automate responses for the voice bot.",
    routeName: "bot-management-voice-bot-id-ivr-config",
  },
  {
    _id: 5,
    bot: "Intent Configuration",
    helperText: "Define the intents that the voice bot will recognize and respond to during interactions with users.",
