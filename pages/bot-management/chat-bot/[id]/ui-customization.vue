          ...
          <div class="flex items-center gap-2">
            <UiFormField v-slot="{ componentField }" name="color">
              <UiFormItem v-auto-animate="animationProps" class="w-full">
                ...
                <UiFormMessage />
                <span class="text-xs text-gray-500">This color will be used for Messages,Widget Bubble</span>
              </UiFormItem>
            </UiFormField>
            <UiFormField v-slot="{ componentField }" name="secondaryColor">
              <UiFormItem v-auto-animate="animationProps" class="w-full">
                ...
                <UiFormMessage />
                <span class="text-xs text-gray-500">This color will be used for chat buttons</span>
              </UiFormItem>
            </UiFormField>
          </div>
