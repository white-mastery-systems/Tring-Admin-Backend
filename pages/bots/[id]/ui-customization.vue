  ...
  <div>
    ...
    <div class="form-align shadow-align ml-11">
      ...
      <div class="mt-6 space-y-1">
        ...
        <div class="color-picker-align shadow-align h-14 gap-8 rounded-lg bg-white px-5">
      ...
      <div class="flex flex-row justify-between py-2">
        <div class="flex flex-col space-y-2">
          ...
          <UiSelect v-model="widgetSound">
            <UiSelectTrigger class="hover:focus:none hover:focus-visible:none shadow-align h-12 w-52">
        ...
        <div class="flex flex-col space-y-2">
          ...
          <UiSelect v-model="widgetPosition">
            <UiSelectTrigger class="hover:focus-visible:none hover:focus:none shadow-align h-12 w-52">
      ...
      <div class="space-y-4 py-5">
        ...
        <div class="flex flex-row justify-between">
          ...
          <UiSwitch id="generate-lead" v-model:checked="generateLead"
