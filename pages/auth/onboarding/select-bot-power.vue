<template>
  <div class="absolute inset-0 bg-gradient-to-br from-yellow-100 via-pink-100 to-blue-100">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
      ...
      <h1 class="text-xl sm:text-2xl md:text-[26px] font-bold mb-0 text-gray-800">Select a Bot to <span class="text-indigo-600">Power Your Support</span> <span class="text-amber-400">
        <img src="assets/icons/Star-Yellow.svg" alt="star" class="inline-block ml-1 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 mb-[30px]" />
      </span></h1>
      
      <p class="text-[14px] text-[#333333] mb-4 sm:mb-6 md:mb-8 text-center">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-4 w-full max-w-xs sm:max-w-xl md:max-w-2xl">
        ...
        <div 
          class="rounded-xl p-4 sm:p-4 md:p-6 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 h-60 sm:h-72 md:h-72"
        ...
        >
          ...
          <h2 class="text-lg sm:text-xl md:text-2xl font-bold mb-1 sm:mb-2" :class="selectedBot === 'chat' ? 'text-amber-400' : 'text-gray-800'">Chatbot</h2>
        ...
        <div 
          class="rounded-xl p-4 sm:p-4 md:p-6 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 h-60 sm:h-72 md:h-72 border border-1 border-[#D9D9D9]"
