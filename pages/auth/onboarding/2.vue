        ...
        <div class="input-container">
          <UiSelect v-model="loginData.avgTraffic">
            ...
            <UiSelectContent>
              ...
              <UiSelectItem value="500-1000 visits">500-1000 visits</UiSelectItem>
              <UiSelectItem value="1000-5000 visits">1000-5000 visits</UiSelectItem>
              <UiSelectItem value="5000-10000 visits">5000-10000 visits</UiSelectItem>
        ...
        <div class="input-container">
          <UiSelect v-model="loginData.employeeCount">
            ...
            <UiSelectContent>
              ...
              <UiSelectItem value="50-100 employees">50-100 employees</UiSelectItem>
              <UiSelectItem value="100-500 employees">100-500 employees</UiSelectItem>
              <UiSelectItem value="500-1000 employees">500-1000 employees</UiSelectItem>
              <UiSelectItem value="1000+ employees">1000+ employees</UiSelectItem>
            </UiSelectContent>
          </UiSelect>
        </div>
      </div>
