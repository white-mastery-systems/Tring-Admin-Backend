  ...
  return chats.map((chat: any) => {
    ...
    const filteredMessages = chat.messages.filter((message: any) =>
      ...
      (message.content.includes('Rescheduled Site') ||
        ...
        message.content.includes('Rescheduled Call') || message.content.includes('Call Scheduled') || message.content.includes('Appointment Scheduled') || message.content.includes('Rescheduled Appointment'))
    );
