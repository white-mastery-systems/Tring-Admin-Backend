<template>
  <Page :title="leadData?.botUser?.name ?? ''" :disable-back-button="false" :disable-elevation="true">
    ...
    <div class="items-top flex gap-[25px justify-center items-center px-3">
      <!-- mx-8 -->
        ...
        <UiTabs default-value="Chat" class="w-full self-center">
          ...
          <!-- <div class="flex justify-center w-[100%]"> -->
            <UiTabsContent value="Chat" class="flex justify-center">
              <div class="flex flex-col items-center gap-2 pl-4 capitalize w-[100%] sm:w-[100%] md:w-[80%] lg:w-[65%] xl:w-[65%]">
                <div
            ...
            <UiTabsContent value="Timeline" class="flex justify-center">
              <div class="flex items-center capitalize py-3 px-5 w-[100%] sm:w-[100%] md:w-[80%] lg:w-[65%] xl:w-[65%]">
                <UiStepper orientation="vertical" class="mx-auto flex w-full flex-col justify-start gap-10">
                  <UiStepperItem v-for="step in steps" :key="step.step" v-slot="{ state }"
                    ...
                    <UiStepperTrigger as-child>
                      <UiButton :variant="state === 'completed' || state === 'active' ? 'default' : 'outline'"
