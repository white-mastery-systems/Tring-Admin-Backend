<template>
  <Page
    :title="leadData?.botUser?.name ?? 'Add Name'"
    :disable-back-button="false"
    :disable-elevation="true"
  >
    <div class="items-top gap-[25px flex items-center justify-center px-3">
      <div
        class="flex w-full grid-cols-2 justify-around gap-8 sm:w-full md:w-[100%] lg:w-[100%] xl:w-[100%]"
      >
        <UiTabs default-value="Chat" class="w-full self-center">
          ...
          >
            ...
            <div
              class="flex w-full flex-col items-center gap-2 pl-0 capitalize sm:pl-0 md:pl-4 lg:pl-4 xl:pl-4"
            >
              <div
              ...
              >
                ...
                <div
                  class="h-screen-minus-13 overflow-y-scroll bg-[#f8f6f6]"
                  ref="chatScreenRef"
                >
                  <div
                    class="w-full p-5"
                  ...
                  >
                    ...
                    >
                      <div
                        class="flex max-w-[80%] flex-col items-end justify-center"
                      >
                    ...
                    >
                      ...
                      >
                        <MdText
                          :content="JSON.parse(messageList.content).response"
                        />
                        <div class="flex flex-col">
                          <div class="flex flex-wrap items-center gap-2">
                            <div
                              class="flex items-center"
                              v-for="(btn, btnIndex) in JSON.parse(
                                messageList.content,
                              ).canned"
                              :key="btnIndex"
                            >
