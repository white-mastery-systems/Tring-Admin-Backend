<template>
  ...
  >
    ...
    <div class="items-top gap-[25px flex items-center justify-center px-3">
      <!-- mx-8 -->
      <div
        class="flex w-full justify-around gap-8 sm:w-full md:w-[100%] lg:w-[100%] xl:w-[100%]"
      >
        <UiTabs default-value="Chat" class="w-full self-center">
          ...
          <UiTabsContent value="Timeline" class="flex justify-center">
            <div
              class="flex w-[100%] items-center px-5 py-3 capitalize sm:w-[100%] md:w-[80%] lg:w-[65%] xl:w-[65%]"
            >
              <UiStepper
