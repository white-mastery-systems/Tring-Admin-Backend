...
import { callLogsRelations, outboundCallSchema, voicebotIntegrationRelations, voicebotLeadSchema, voicebotRelations, voicebotSchedularSchema } from "../schema/voicebot";
