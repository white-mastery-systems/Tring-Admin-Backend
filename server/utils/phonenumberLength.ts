...
export const phoneLength = [
  ...
  { code: "AX", label: "Alland Islands", phone: "358", min: 7, max: 10, phoneLength: [7, 8, 9, 10] },
  ...
  { code: "FI", label: "Finland", phone: "358", min: 9, max: 11, phoneLength: [9, 10, 11] },
  ...
  { code: "JP", label: "Japan", phone: "81", suggested: true, phoneLength: [10, 11] },
  ...
  { code: "MM", label: "Myanmar", phone: "95", min: 7, max: 10, phoneLength: [7, 8, 9, 10] },
