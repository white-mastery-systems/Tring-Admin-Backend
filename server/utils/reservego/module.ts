...
export const createNewReservation = async (integrationData: any, reqObj : any) => {
  try {
    const data: any = await $fetch(`${reverseGoBaseUrl}/api/bookings/reservation/create`, {
      method: "POST",
      body: {
...
export const getReservationStatus = async (integrationData: any, reqObj : any) => {
  try {
    const data: any = await $fetch(`${reverseGoBaseUrl}/api/bookings/reservation/status`, {
      method: "POST",
      body: {
