  ...
  <div class="navigation-drawer-main">
    ...
    >
      <span>
        ...
        <img
          v-else
          src="assets\icons\customisation_deactive.svg"
          width="22"
          height="22"
        />
      </span>
    ...
    <div
      :class="[route.path === '/settings' ? 'activeClass' : 'default-align']"
      @click="
        async () => {
    ...
    >
      <span>
        ...
        <img
          v-else
          src="assets\icons\settings_deactive.svg"
          width="22"
          height="22"
        />
      </span>
