...
<template>
  <div class="flex w-full items-center justify-center">
    <label for="dropzone-file"
      ...
      <!-- @vue-ignore -->
      <input id="dropzone-file" type="file" class="hidden" :accept="accept" @change="file = $event.target.files"
        v-bind="$attrs" />
    </label>
    <div class="flex flex-col items-center justify-center px-4 pb-6 pt-5">
      <label for="dropzone-file"
        class="cursor-pointer mb-2 line-clamp-3 w-fit text-center text-sm text-gray-500 dark:text-gray-400">
