      ...
      <div v-else class="w-full">
        <div v-if="selectedType === 'Website'" class="w-full space-y-4">
          ...
          <div class="bg-[#E2E8F0] rounded-lg p-4 text-[12px] md:text-[14px] text-left">
            ...
            <div>
              All your company's branding elements, including colors, logos, and key information, will be automatically imported from the website link you provide, ensuring a seamless and accurate representation of your brand.
            </div>
          </div>
        ...
        <div v-else-if="selectedType === 'Document'" class="w-full py-4">
          ...
          <div class="bg-[#E2E8F0] rounded-lg p-4 text-[12px] md:text-[14px] my-4 text-left">
            <div class="font-medium">Note:</div>
            <div>
              A sample document for the industry has been provided below. You can download and edit the necessary fields of this document and upload it.
            </div>
          </div>
        ...
        <div v-else-if="selectedType === 'Text'" class="w-full space-y-4">
          ...
          <div class="text-left flex flex-col gap-2">
            ...
            <TextDocumentUpload ref="uploadDocumentRef" :refresh="props.refresh" :contentSuggestions="props.suggestionsContent" />
          </div>
        </div>
      </div>
    </div>
