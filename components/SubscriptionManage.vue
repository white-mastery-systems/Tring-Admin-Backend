...
<template>
  ...
  <page v-else title="Billing" :description="true" :disableSelector="false" :disable-back-button="true">
    ...
    <!-- field_shadow -->
    <div class="field_shadow rounded-lg bg-[#fffff] w-full self-center rounded-lg bg-[#fffff]">
      <div
      ...
      <div class="flex items-center justify-between gap-3 px-[30px] py-5 font-medium">
      ...
      <div class="flex items-center justify-between gap-3 rounded-b-lg px-[30px] py-5 font-medium">
