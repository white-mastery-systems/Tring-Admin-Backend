<template>
  <div class="navigation-drawer-main">
    ...
    <NuxtLink
      to="/"
      :class="[route.path === '/' ? 'activeClass' : 'default-align']"
    >
      <span>
        <img
          v-if="route.path === '/'"
    ...
    >
      <span>
        <img
          v-if="route.path?.includes('/leads')"
          src="
      assets\icons\analytics_active.svg"
          width="22"
          height="22"
        />
        <img
    ...
    <NuxtLink
      to="/bots"
      :class="[route.path?.includes('/bots') ? 'activeClass' : 'default-align']"
    >
      <span>
        <img
          v-if="route.path?.includes('/bots')"
    ...
    >
      <span>
        <img
          v-if="route.path?.includes('/billing')"
