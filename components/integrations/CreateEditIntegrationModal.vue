  ...
  <DialogWrapper v-model="integrationModalState.numberModalState" :title="integrationModalState.numberModalState?.id
    ...
    <form @submit="handleConnect" class="space-y-2">
      ...
      <div class="flex flex-col gap-2">
        ...
        <SelectField name="crm" :label="findIntegrationTypeLabel()" :placeholder="findIntegrationTypeLabel()"
          helperText="Select your channel" :options="integrationTypes" required />
        <div class="relative">
