<script setup lang="ts">
    ...
    const emit = defineEmits<{ (e: "confirm"): void,(edit: "getApistatus"): void  }>();
    ...
    const {
      ...
      debounce(templateStore.updateValues(
        {...values,
        templateVariables:stringifyJson(values.templateVariables)
        headerTextTemplateVariables: stringifyJson(values.headerTextTemplateVariables)
      }
      ), 1000);
      console.log("dispatchTemplate",templateStore.values.templateVariables);
    };
    ...
    if (whatsppModalState?.id && whatsppModalState.getStatus) {
      ...
      setFieldValue("templateVariables", parseJson(getSingleDetails.templateVariables));
      setFieldValue("headerTextTemplateVariables", parseJson(getSingleDetails.headerTextTemplateVariables));
  ...
  console.log(templateStore.values.templateVariables);
    ...
    setFieldValue("templateVariables", templateStore.values.templateVariables);
    setFieldValue("headerTextTemplateVariables", templateStore.values.headerTextTemplateVariables);
    if (
